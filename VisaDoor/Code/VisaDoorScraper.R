...
url_base_1 <- "http://visadoor.com/greencards/index?company=&job=&country=Venezuela&state=&year="
url_base_2 <- "&submit=Search"

# create empty list to be filled with tables
visa.table <- list("2008" = NA, "2009" = NA, "2010" = NA, "2011" = NA, "2012" = NA, "2013" = NA, "2014" = NA, "2015" = NA, "2016" = NA, "2017" = NA)
# create empty list to be filled with links
visa.hlinks <- list("2008" = NA, "2009" = NA, "2010" = NA, "2011" = NA, "2012" = NA, "2013" = NA, "2014" = NA, "2015" = NA, "2016" = NA, "2017" = NA)
# loop through years
...
visa.table.hlinks <- list("2008" = NA, "2009" = NA, "2010" = NA, "2011" = NA, "2012" = NA, "2013" = NA, "2014" = NA, "2015" = NA, "2016" = NA, "2017" = NA)
...
# save data
saveRDS(visa.table.hlinks, "VisaDoorOutput1.rds")
write.csv(visa.table.hlinks, "VisaDoorOutput1.csv")
...
# load data
VisaDoorOutput1 <- readRDS("VisaDoorOutput1.rds")
# base url
...
# save data
saveRDS(application.table, "VisaDoorOutput2.rds")
write.csv(application.table, "VisaDoorOutput2.csv")
...
# load data
VisaDoorOutput2 <- readRDS("VisaDoorOutput2.rds")
...
# save data
saveRDS(certification.table, "VisaDoorOutput3.rds")
write.csv(certification.table, "VisaDoorOutput3.csv")
